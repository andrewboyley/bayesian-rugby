...
test('OpenSpec visual-system: app shell resolves canvas, mono, and graph-panel tokens', async ({ page }) => {
	...
	await expect(page.locator('meta[name="description"]')).toHaveAttribute('content', 'Explore the Wikipedia concept network as an interactive graph.');
